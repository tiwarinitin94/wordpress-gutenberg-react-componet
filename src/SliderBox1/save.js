                        ...
                        <div class="slider">
                            {
                                props.attributes.attribute.map((item, i) => {
                                    return (
                                        <div class="slide">
                                            <p style={{ color: props.attributes.textFontColor }}><RichText.Content value={item.text} /></p>
                                            <div class="author"><RichText.Content value={item.author_name} /></div><div class="company"><RichText.Content value={item.company} /></div>
                                        </div>
                                    )
                                })
                            }
